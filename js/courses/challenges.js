...
export const CHALLENGES = [
  ...
  },
  {
    ...
    hint: 'q0 と q2 が連動して変わる=「もつれ」が必要。q1 に X、q0 に H、そして q0 を制御にした CNOT(●)で q2 へ。',
  },
  {
    title: '課題7',
    ...
    hint: '4曲はどれも「1の数が偶数」。q0 と q1 に H、q0→q2 と q1→q2 に CNOT でパリティを書き込む。',
  },
  {
    title: '課題8',
    text: '<strong>グローバー探索</strong>: 「振幅増幅」を使って、曲 <code>111</code>「ドラムンベース」の確率を 75% 以上にせよ(ただし 100% 未満。CCNOT を2回以上使うこと)。これは本物の量子コンピュータの有名アルゴリズムだ!',
    allowed: ['X', 'H', 'R', 'CNOT', 'CCNOT'],
    judge: (c) => inRange(c.probs[7], 0.75, 0.99) && c.counts.CCNOT >= 2,
    hint: '① 全行に H(8曲を均等ミックス) ② オラクル: q2 を H → CCNOT → H で挟むと「111 だけ位相反転」(CCZ)。音は変わらないが 111 に印がつく ③ 拡散: 全行 H → 全行 X → ②と同じ CCZ → 全行 X → 全行 H。印をつけた 111 の振幅だけが増幅されて約78%になる(全11列)。',
  },
];

export const TRY_DONE_TEXT =
  '🏆 全課題クリア!キミはもう量子DJだ。「フリー」コースで最大15ステップの自由なプログラミングを楽しもう。ここで学んだ X・Y・Z・H・R・CNOT・CCNOT は、本物の量子コンピュータのプログラミングでもほぼそのまま使われている。';
