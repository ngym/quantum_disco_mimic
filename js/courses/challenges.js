...
export const CHALLENGES = [
  ...
  {
    title: '課題8',
    text: '<strong>グローバー探索</strong>: 位相で印をつけた曲を <code>G</code>(振幅増幅)でブーストして、曲 <code>111</code>「ドラムンベース」の確率を 90% 以上にせよ(ただし 100% 未満)。これは本物の量子コンピュータの有名アルゴリズムだ!',
    allowed: ['X', 'H', 'R', 'CNOT', 'CCNOT', 'G'],
    judge: (c) => inRange(c.probs[7], 0.9, 0.99) && c.counts.G >= 1,
    hint: '① 全行に H(8曲を均等ミックス) ② オラクル: q2 を H → CCX → H で挟むと「111 だけ位相反転」(CCZ)。音は変わらないが 111 に印がつく ③ G で増幅 → 約78% ④ もう一度 ②③ を繰り返すと約94.5%!(全9列)。Gの中身は「全行H → 全行X → CCZ → 全行X → 全行H」と同じ働き。',
  },
];
